...
q15_16_t sin_LUT_fixedPoint(q15_16_t radians)
{
	...
	// 9 bits of "radians_shifted" to align with the array indices (i.e. aligning the input to have 6 fractional bits is eequivalent
	...
	return sinTable_fixedPoint[ radians_shifted & 0x1FF ];
}
